...
{
    public static List<string> usersFacts = new List<string>();
    public static async Task AiContextProvider(IConfiguration configuration, IServiceProvider serviceProvider)
    {
